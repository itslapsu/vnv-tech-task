...
const ProjectsSection = () => {
  return (
    <Element name="ProjectsSection" className="container">
          ...
          <SliderComponent>
            <SwiperSlide>
              <ProjectItem image={image1} url={"/"}>
                ...
                condimentum quis felis. Fusce aliquam, quam eget laoreet
                commodo, libero lacus vehicula nulla, et luctus risus elit quis
                purus. Morbi consectetur nunc eget nulla fringilla dapibus vitae
                quis nisl. Nullam et nibh nisi.
              </ProjectItem>
            </SwiperSlide>
            <SwiperSlide>
